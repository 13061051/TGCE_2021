...
class GRU_GNN_Vector(nn.Module):
	def __init__(self, in_dim, hidden_dim,drop_out=0.0,gnn_function='GRU_POSGAT'):
...
class GNN_Match(nn.Module):
	def __init__(self, num_items,embeds, embedding_dim,drop_out=0.0,gnn_function='GRU'):
		super().__init__()
		...
		self.gcn_l1 = GRU_GNN_Vector(in_dim,hidden_dim,drop_out=drop_out,gnn_function=gnn_function)
		self.gcn_l2 = GRU_GNN_Vector(in_dim,hidden_dim,drop_out=drop_out,gnn_function=gnn_function)
		self.gcn_l3 = GRU_GNN_Vector(in_dim,hidden_dim,drop_out=drop_out,gnn_function=gnn_function)
		self.gcn_l4 = GRU_GNN_Vector(in_dim,hidden_dim,drop_out=drop_out,gnn_function=gnn_function)
