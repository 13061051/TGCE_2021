...
if __name__ == '__main__':
	...
	user_macth_model = gnn_models.GNN_Match(num_items=num_items, embeds=embeds,
	                                        embedding_dim=embedding_dim, drop_out=args.dropout,gnn_function=args.gnn_function,
